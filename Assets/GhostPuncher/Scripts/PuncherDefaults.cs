...
public class PuncherDefaults : ScriptableObject
{
	...
	[Header("Punch")]
	[Tooltip("Stats for normal punch")]
	public PunchData NORMAL_PUNCH_DATA;
	...
	[Header("Mega punch stats")]
	public PunchData MEGAPUNCH_DATA;
	...
	[Tooltip("The init speed of the charge")] public float CHARGE_START_SPEED;
	[Tooltip("The desired speed of the charge")] public float CHARGE_MAX_SPEED;
	[Tooltip("Charge accelerates at this rate at the start of the charge")] public float CHARGE_ACCELERATION;
	[Tooltip("Multiplier on moving left/right while charge active")] public float CHARGE_MOVE_LEFT_RIGHT_DAMPING;
	[Tooltip("Multiplier on looking left/right while charge active")] public float CHARGE_LOOK_LEFT_RIGHT_DAMPING;
	[Tooltip("Multiplier on looking up/down while charge active")] public float CHARGE_LOOK_UP_DOWN_DAMPING;
	[Tooltip("Stamina drain per second while charging")] public float CHARGE_STAMINA_DRAIN;
	[Tooltip("Maximum object height we can hit before stopping")] public float CHARGE_MAX_HEIGHT;
	[Tooltip("Time spent charging up before we start running")] public float CHARGE_CHARGE_TIME;
	[Tooltip("Time it takes to slide to a stop")] public float CHARGE_STOP_TIME;
	[Tooltip("Time after clicking punch that it actually goes through")] public float CHARGE_PUNCH_DELAY;
	[Tooltip("Time after charge punching it takes to stop (very quick I imagine)")] public float CHARGE_PUNCH_STOP_TIME;
